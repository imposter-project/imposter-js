Sample project for Imposter with Vitest, using TypeScript and ECMAScript modules (ESM)
=======================================================================================
...
A mock defined entirely within the [Vitest test](src/__tests__/users.test.ts) - no OpenAPI specification, no Imposter configuration - all configured within the Vitest test.
